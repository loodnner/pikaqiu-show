...
var player = {
  init: function init() {
    demo.innerText = _css.str.substr(0, n);
    demo2.innerHTML = _css.str.substr(0, n);
    player.play();
  },
  readString: function readString() {
    n += 1;

    if (n > _css.str.length) {
      window.clearInterval(id);
      return;
    }

    demo.innerText = _css.str.substr(0, n); //文本形式输出

    demo2.innerHTML = _css.str.substr(0, n); //html标签输出style标签
...
},{}]},{},["../../../../.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js","show.js"], null)
